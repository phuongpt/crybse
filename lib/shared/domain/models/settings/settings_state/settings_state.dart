import 'package:crybse/shared/domain/models/settings/settings_details/settings_details.dart';
...
abstract class SettingsState with _$SettingsState {
  ...
  const factory SettingsState.data({required SettingsDetails details}) = _SetttingsStateData;
