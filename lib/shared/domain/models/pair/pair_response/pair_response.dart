...
abstract class PairResponse with _$PairResponse {
  const factory PairResponse(PairSummary result, Allowance allowance) = _PairResponse;

  factory PairResponse.fromJson(Map<String, dynamic> json) => _$PairResponseFromJson(json);
}
