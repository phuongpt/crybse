...
abstract class ExchangesResponse with _$ExchangesResponse {
  const factory ExchangesResponse({required List<Exchange> result}) = _ExchangesResponse;

  factory ExchangesResponse.fromJson(Map<String, dynamic> json) => _$ExchangesResponseFromJson(json);
}
