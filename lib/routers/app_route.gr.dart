...
import 'package:crybse/features/splash/presentation/pages/splash_page.dart'
    as _i3;
import 'package:crybse/shared/domain/models/market/market.dart' as _i11;
...
class SignInPageRoute extends _i9.PageRouteInfo<void> {
  const SignInPageRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class MarketDetailPageRoute
    extends _i9.PageRouteInfo<MarketDetailPageRouteArgs> {
  MarketDetailPageRoute({
    _i10.Key? key,
    required _i11.Pair pair,
  ...
  static const _i9.PageInfo<MarketDetailPageRouteArgs> page =
      _i9.PageInfo<MarketDetailPageRouteArgs>(name);
}
...
class SearchPageRoute extends _i9.PageRouteInfo<void> {
  const SearchPageRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i7.MarketPage]
class MarketPageRoute extends _i9.PageRouteInfo<void> {
  const MarketPageRoute({List<_i9.PageRouteInfo>? children})
      : super(
...
class SignUpPageRoute extends _i9.PageRouteInfo<void> {
  const SignUpPageRoute({List<_i9.PageRouteInfo>? children})
      : super(
