...
class SignInController extends StateNotifier<SignInState> {
  ...
  void updatePassword(String value) {
    ...
    state = state.copyWith(password: password, isValid: validate(password: password));
  }
  ...
  Future<void> signInWithPassword() async {
    ...
    try {
      ...
      state = state.copyWith(status: FormzSubmissionStatus.success, message: '');
...
final signInNotifierProvider =
    StateNotifierProvider<SignInController, SignInState>((ref) => SignInController(AuthUsecase(repository: ref.read(authRepositoryProvider))));
